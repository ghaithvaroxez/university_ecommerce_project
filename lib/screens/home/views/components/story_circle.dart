    ...
    return GestureDetector(
      ...
      Container(
        ...
        child: CircleAvatar(
          ...
          radius: 40,
          child: CircleAvatar(
            backgroundImage: NetworkImage(imgUlr),
            radius: 37,
            child: Stack(
              children: [
                Positioned(right:0,bottom:0,child: CircleAvatar(backgroundColor:Colors.green.shade700,radius: 10,))
              ],
            ),
          ),
        ),
      ...
      //           child: CircleAvatar(
      //             backgroundColor:
      //                 Online ? Colors.green.shade800 : Colors.transparent,
      //             radius: 8,
      //           ))
      //     ],
      //   ),
