...
class DarkColor {
  static const Color background = Color(0XFF1A121E);

  static const Color titleTextColor = const Color(0xffFFFFFF);
  static  Color subTitleTextColor =  Color(0xffFCBC3C).withOpacity(0.6);
  ...
  static const Color yellowColor = Color(0xffFCBC3C);
